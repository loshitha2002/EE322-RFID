...
// ============================================================================
// If your driver turns ON when PD7 is HIGH (typical MOSFET low-side): set 1
// If your driver turns ON when PD7 is LOW (some relay modules): set 0
